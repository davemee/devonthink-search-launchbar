...
2025-04-18 21:22 dave@davemee.com	butchered references to 'DEVONthink 3' to 'DEVONthink' so it runs on the beta 4 (and hopefully 5 onwards, which is stabilising on this name), set LaunchBar shortcut to 'sd'
